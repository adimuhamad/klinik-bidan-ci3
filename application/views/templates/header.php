...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>bower_components/datatables.net/css/jquery.dataTables.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('dashboard') ?>" class="logo">
      ...
      <span class="logo-lg"><i class="fa fa-user-md"></i><b> KLINIK ZAHRA</b></span>
    </a>
